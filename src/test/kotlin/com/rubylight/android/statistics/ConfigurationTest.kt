...
class ConfigurationTest: BaseTest() {
    ...
    fun testInitConfig() {
        ...
        Truth.assertThat(initConfig.serverUrl).isNull()
        ...
        Truth.assertThat(initConfig.serverUrl).isEqualTo("abc")
    ...
    fun testSpecialLocalhost() {
        ...
        Truth.assertThat(configuration.apiKey).isEqualTo(apiKey)
        Truth.assertThat(configuration.serverUrl.toString()).isEqualTo(serverUrl)
